...
We can analysis the convergence and disconvergence of this complex map too. For a certain $c$, now we consider the convergence and disconvergence for every point in the space.\\[4ex]
\begin{figure}[H]
