...
As the analysis of Lorenz map still difficult. Henon present another method in 1976\footnote{Hénon, M., 2021. A two-dimensional mapping with a strange attractor.}. And this is Henon's map.
...
\begin{discussion}\textbf{Axis transform and map}
\\\noindent We can discribe a map as a transform of coordinate. For example, a linear transform is a one-to-one transform. That means, for ever point in original system, exists only one point in the transformed system and vice versa. 
\end{discussion}
