...
In the section 3, we mainly discussed the judgement of chaos in 1 dimension. Here we will focus on the Lyapunov exponent in high dimension. Obviously, in high dimension, the $\delta_n$ function we used in Discussion \ref{Lyapunov-exp-discussion} will be a $m$ dimension vector $\mathbf \delta_n$ and we have
$$
