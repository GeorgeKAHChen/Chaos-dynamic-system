...
$\text{Lyapunov spectrum} = (0.42040807, 0.01305949), \text{sum} = 0.4334675666638811$
\end{example}
...
\end{center}
\end{figure}
$\text{Lyapunov spectrum} = (0.104081796, 0.00285865072 -9.75901813), \text{sum} = -9.652077679944226$
\end{example}
...
\end{center}
\end{figure}
$\text{Lyapunov spectrum} = (0.104081796, 0.002.85865072, -9.75901813), \text{sum} = -9.629091584454333$
\end{example}
